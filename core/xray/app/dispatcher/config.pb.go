...
var file_config_proto_goTypes = []any{
	(*SessionConfig)(nil), // 0: ljfxznode.core.app.dispatcher.SessionConfig
	(*Config)(nil),        // 1: ljfxznode.core.app.dispatcher.Config
}
var file_config_proto_depIdxs = []int32{
	0, // 0: ljfxznode.core.app.dispatcher.Config.settings:type_name -> ljfxznode.core.app.dispatcher.SessionConfig
