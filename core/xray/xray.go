...
import (
	...
	_ "github.com/csdfsdffese/ljfxznode/core/xray/distro/all"
...
type Xray struct {
	...
	// trafficMu guards nodeReportMinTrafficBytes: AddNode (task goroutines of
	// multiple node controllers) and GetUserTrafficSlice run concurrently.
